...
public class updatetrain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatetrain);
        ...
        Button updatetrain = findViewById(R.id.updatetrain);
        ...
        dt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(updatetrain.this, date, myCalendar
        ...
        updatetrain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(updatetrain.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Boolean checkid= DB.checkid(id);
                    if (checkid==true){
                        Boolean update = DB.updateTrain(id,departure,arrival,date,total_seats);
                        if (update==true){
                            Toast.makeText(updatetrain.this, "Train updated successfully", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(getApplicationContext(), adminpanel.class);
                            startActivity(intent);
                        }
                        else {
                            Toast.makeText(updatetrain.this, "New entry not updated", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else {
                        Toast.makeText(updatetrain.this, "ID does not exists", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
