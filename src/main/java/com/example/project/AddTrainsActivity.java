...
public class AddTrainsActivity extends AppCompatActivity {
    final Calendar myCalendar = Calendar.getInstance();
    private EditText Trainid, from, to, dt, seats,dep;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addtrains);
        ...
        dep = findViewById(R.id.dep_time);
        ...
        dt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AddTrainsActivity.this, date, myCalendar
        ...
        addtrain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id.equals("") || departure.equals("") || arrival.equals("") || date.equals("") || total_seats.equals("")) {
                    Toast.makeText(AddTrainsActivity.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                } else {
                    Boolean checkid = DB.checkid(id);
                    if (checkid == false) {
                        Boolean insert = DB.insertTrain(id, departure, arrival, date, total_seats);
                        if (insert == true) {
                            Toast.makeText(AddTrainsActivity.this, "Train has been added", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(getApplicationContext(), adminpanel.class);
                            startActivity(intent);
                        } else {
                            Toast.makeText(AddTrainsActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(AddTrainsActivity.this, "ID already exists", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
